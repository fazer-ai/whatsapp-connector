...
// What closes that window is the caller naming the message, which it does, and the
// receiving client dropping the repeat.
//
...
// provably never went out and a resend gets it right.
